...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 22, 2024 lúc 04:34 PM
...
(29, 'Trang web cần cải thiện', '<p><strong>Cần được cải thiện nhiều hơn</strong> <i>chức năng</i></p>', 'đông đặng', '2024-10-02 19:17:57', 'không hiển thị', 0, '/images/', 1),
(30, 'Bài viết mới nhất nè', '<p>Nội dung bài viết mới nhất</p>', 'Khánh Đông', '2024-10-31 20:44:55', 'hiển thị', 2, '/images/wallpaper8.jpg', 2);
...
(7, 'khanhdong@gmail.com', 'Bài viết hay nhất vũ trụ\r\n', 17),
(8, 'sfd', 'ạ', 6),
(9, 'khanhdong@gmail.com', 'bài viết này cũng được', 30);
...
(2, 'DKD', '0306221014@gmail.com', '', 'chưa đầy đủ', 'đã duyệt'),
...
(8, 'đông', 'dongdk@gmail.com', 'abc', 'abc', 'đã duyệt'),
(9, 'Giang Mỹ Phụng', 'giangmyphung@gmail.com', 'Trang web cần được phát triển thêm nhiều tính năng hơn', 'Cần phát triển chức năng phân trang\r\nnội dung hiển thị trực quang hơn\r\n- Giao diện cần được tối ưu pf hơn', 'đã duyệt'),
(10, 'Đỗ Nguyễn Trung Nguyên', 'donguyentrungnguyen@gmailcom', 'Trang web cần cải thiện performance', 'Trang web cần cải thiện performance\r\n', 'chờ duyệt');
